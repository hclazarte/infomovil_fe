...
class MenuIcon extends React.Component {
  constructor(props){
    super(props);
    this.state = {style: "hamMenuCanvasHide"};
                    ...
                    <ul>
                      <li>
                        <Link to="/" onClick={this.onMenuOptClick}>
                          <div className="hamMenuDiv">
                            <svg className="hamMenuIcon" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 477.846 477.846">
                              <g>
                                <g>
                      ...
                      <li> 
                        <Link to="/ayuda" onClick={this.onMenuOptClick}>
                          <div className="hamMenuDiv">
                            <svg className="hamMenuIcon" version="1.1" x="0px" y="0px"  width="20px" height="20px" viewBox="0 0 512 512" >
                              <g>
                                <g>
                                  <g>
                      ...
                      <li>
                        <Link to="/servicios" onClick={this.onMenuOptClick}>
                          <div className="hamMenuDiv">
                            <svg className="hamMenuIcon" width="20px" height="20px" viewBox="0 0 512 512">
                              <g>
                      ...
                      <li>
                        <div className="hamMenuDiv">
                          <svg className="hamMenuIcon" width="20px" height="20px" x="0px" y="0px" viewBox="0 0 512 512">
                          <g>
                            <g>
                      ...
                      <li>
                        <div className="hamMenuDiv">
                          <svg className="hamMenuIcon" x="0px" y="0px" viewBox="0 0 390 390" width="20px" height="20px">
                          <g>
                            <g>
  ...
  onMenuClick() {
    this.setState({style: "hamMenuCanvasShown"});
  }
  onPanellClick() {
